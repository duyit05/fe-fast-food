  ...
  <div id="page">
    <main className="bg_gray">
      <div className="container margin_30">
        <table className="table table-striped product-list mb-5">
          <thead>
            <tr>
              <th>
                Product
          ...
          <tbody>
            <tr>
              <td>
                <div className="thumb_product">
                  <img src="img/products/product_placeholder_square_small.jpg" data-src="img/products/shoes/1.jpg" className="lazy" alt="123" />
                </div>
                <span className="item_product"><a href="123">Armor Air x Fear</a></span>
              </td>
              <td>
              ...
              <td>
                <span className="badge rounded-pill bg-success">Shipped</span>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                <span className="badge rounded-pill bg-secondary">Cancelled</span>
              </td>
            </tr>
            <tr>
              <td>
